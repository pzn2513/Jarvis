...
特殊区域(){
    ...
    mwaitfunc([
        ...
        特殊区域_上路],
        [()=>mgetpix([[1309,887,0xA73330,10], [1321,885,0xEB2A29,10]]),特殊区域_下路],
    ],"路线分析")
}
零号业绩(){
    零号业绩_start()
    ; 分析路线 1316, 225,0x324147 
    mwaitfunc([
        [()=>mgetpix([[1307,226,0xDFD73E,30], [1318,226,0xF63948,30]]),
        零号业绩_上路],
        [()=>mgetpix([[1309,887,0xA73330,30], [1321,885,0xEB2A29,30]]),零号业绩_下路],
    ],"路线分析")
    ; mwaitfunc([
    ;     [()=>mgetpix([[1307,226,0xDFD73E,10], [1318,226,0xF63948,10]]),
    ;     零号业绩_giveup],
    ;     [()=>mgetpix([[1309,887,0xA73330,10], [1321,885,0xEB2A29,10]]),零号业绩_giveup],
    ; ],"路线分析")1308,886,0x5E2025
}
零号业绩_start(){
