...
零号业绩(){
    ...
    mwaitfunc([
        ...
        零号业绩_上路],
        [()=>getpix(1385,887,0xEA212C,16),零号业绩_下路],
        [()=>getpix(1280,850,0xDB2325,16),零号业绩_下路],
    ],"路线分析")
}
零号业绩_上路(){
    WinActivate("绝区零 ahk_class UnityWndClass")
...
零号业绩_battle(){
    ...
    mwaitfunc([
        [()=>getpix(560,309,0x41C01D,16),()=>waitpix(560,309,0x41C01D,6,-3,()=>click(1136,920))],
        [()=>getpix(560,266,0x44C41C,16),()=>waitpix(560,266,0x44C41C,6,-3,()=>click(1136,998))],
        [()=>getpix(560,373,0x41C01D,16),()=>waitpix(560,373,0x41C01D,6,-3,()=>click(1136,892))], ;latest，到这应该全部奖励拿完
        [()=>getpix(560,267,0x3AC618,16),()=>waitpix(560,267,0x3AC618,6,-3,()=>click(1136,1005))], ;调查点上限，但业绩奖励有
